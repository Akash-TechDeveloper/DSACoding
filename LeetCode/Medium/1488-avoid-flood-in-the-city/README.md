<h2><a href="https://leetcode.com/problems/avoid-flood-in-the-city/?envType=daily-question&envId=2025-10-08">1488. Avoid Flood in The City</a></h2><h3>Medium</h3><hr><p>Your country has an infinite number of lakes. Initially, all the lakes are empty, but when it rains over the <code>n<sup>th</sup></code> lake, the <code>n<sup>th</sup></code> lake becomes full of water. If it rains over a lake that is <strong>full of water</strong>, there will be a <strong>flood</strong>. Your goal is to avoid floods in any lake.</p>
